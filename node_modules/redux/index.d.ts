...
/**
 * State base type for store created with `combineReducers()`.
 *
 ...
 *
 * *Do not put API calls into store.*
 *
 ...
 *
 * @template A The type of actions the store can potentially respond to.
 */
 ...
 *
 * @template M Object map of store as provided to `combineReducers(map: M)`.
 */
 ...
 *   is to use ES6 `import * as store` syntax. The store may never
...
export interface Store<S = any, A extends Action = AnyAction> {
   ...
   * load some of the store dynamically. You might also need this if you
 ...
 * including store setup, store, data fetching, and more.
 *
 ...
 * parts of the state tree respond to actions, you may combine several store
